...
/**
 * Entity mapped to table JUROR_SURVEY.
 */
public class JurorSurvey {
    ...
    private transient JurorSurveyDao myDao;
    ...
    public JurorSurvey(Long id) {
        this.id = id;
    }

    public JurorSurvey(Long id, long jurorId, long surveyId) {
        this.id = id;
    ...
    public void __setDaoSession(DaoSession daoSession) {
        ...
        myDao = daoSession != null ? daoSession.getJurorSurveyDao() : null;
    }
